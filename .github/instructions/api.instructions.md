...
- `AIExposeEntitiesApiClientError` (Base)
- `AIExposeEntitiesApiClientCommunicationError` (Network, timeout, HTTP errors)
- `AIExposeEntitiesApiClientAuthenticationError` (401, 403, invalid credentials)
