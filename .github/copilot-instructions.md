...
- `entity/` - Base entity class (`AIExposeEntitiesEntity`)
...
- All entities inherit: `(PlatformEntity, AIExposeEntitiesEntity)` - order matters for MRO
...
- Adjust log level: `custom_components.ai_expose_entities: debug` in `config/configuration.yaml`
