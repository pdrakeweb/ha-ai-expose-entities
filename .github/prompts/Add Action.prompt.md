...
**File:** `custom_components/ai_expose_entities/services.yaml`
...
Create `custom_components/ai_expose_entities/service_actions/[action_name].py`:

```python
"""[Action name] service action for AI Expose Entities."""
...
**File:** `custom_components/ai_expose_entities/__init__.py`
...
**File:** `custom_components/ai_expose_entities/const.py`
...
3. Find service action: `ai_expose_entities.[action_name]`
...
- **Service actions directory:** `custom_components/ai_expose_entities/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/ai_expose_entities/services.yaml` (legacy filename)
- **Icons:** `custom_components/ai_expose_entities/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/ai_expose_entities/translations/*.json` under `services` key (legacy)
