...
- Inherit from `AIExposeEntitiesEntity` and platform base class
...
- Entity: `custom_components/ai_expose_entities/[platform]/[entity_name].py`
- Platform: `custom_components/ai_expose_entities/[platform]/__init__.py`
