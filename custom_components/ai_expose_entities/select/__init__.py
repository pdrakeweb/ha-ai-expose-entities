"""Select platform for ai_expose_entities."""
...
from .fan_speed import ENTITY_DESCRIPTIONS as FAN_SPEED_DESCRIPTIONS, AIExposeEntitiesFanSpeedSelect
...
async def async_setup_entry(
    ...
    async_add_entities(
        AIExposeEntitiesFanSpeedSelect(
