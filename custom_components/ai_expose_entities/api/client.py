"""
API Client for ai_expose_entities.
...
class AIExposeEntitiesApiClientError(Exception):
...
def _verify_response_or_raise(response: aiohttp.ClientResponse) -> None:
    ...
    Raises:
        AIExposeEntitiesApiClientAuthenticationError: For 401/403 errors.
        aiohttp.ClientResponseError: For other HTTP errors.

    """
    if response.status in (401, 403):
        msg = "Invalid credentials"
        raise AIExposeEntitiesApiClientAuthenticationError(
            msg,
        )
    response.raise_for_status()


class AIExposeEntitiesApiClient:
    """
    ...
    async def async_get_data(self) -> Any:
        ...
        Raises:
            AIExposeEntitiesApiClientAuthenticationError: If authentication fails.
            AIExposeEntitiesApiClientCommunicationError: If communication fails.
            AIExposeEntitiesApiClientError: For other API errors.
    ...
    async def _api_wrapper(
        ...
        try:
            ...
            raise AIExposeEntitiesApiClientCommunicationError(
                msg,
            ) from exception
            ...
            raise AIExposeEntitiesApiClientError(
                msg,
            ) from exception
