"""Device info utilities for ai_expose_entities."""
...
def create_device_info(
    ...
    return DeviceInfo(
        ...
        name=name or "AI Expose Entities",
        manufacturer=manufacturer or "AI Expose Entities",
...
def get_device_identifiers(config_entry: ConfigEntry) -> set[tuple[str, str]]:
    ...
    Example:
        ...
        >>> # Returns: {('ai_expose_entities', 'entry_id_value')}
    """
