"""
Base entity class for ai_expose_entities.
...
from custom_components.ai_expose_entities.const import ATTRIBUTION
...
class AIExposeEntitiesEntity(CoordinatorEntity[AIExposeEntitiesDataUpdateCoordinator]):
    """
    Base entity class for ai_expose_entities.
